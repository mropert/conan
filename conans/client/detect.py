...
def _sunstudio_compiler(output, compiler_exe="cc"):
    try:
...
def _get_default_compiler(output):
    ...
    if cc or cxx:  # Env defined, use them
        ...
        if platform.system() == "SunOS" and command.lower() == "cc":
            return _sunstudio_compiler(output, command)
    ...
    if platform.system() == "SunOS":
        sunstudio = _sunstudio_compiler(output)
    ...
    if platform.system() == "Windows":
        ...
        return sunstudio or gcc or clang
    else:
        return gcc or clang
