...
macro(conan_set_libcxx)
    if(DEFINED CONAN_LIBCXX)
        ...
        if(CONAN_COMPILER STREQUAL "sunstudio")
...
function(check_compiler_version)
    ...
    elseif(CONAN_COMPILER STREQUAL "gcc" OR CONAN_COMPILER MATCHES "clang" OR CONAN_COMPILER STREQUAL "sunstudio")
...
function(conan_check_compiler)
    ...
    if( (CONAN_COMPILER STREQUAL "Visual Studio" AND NOT CMAKE_CXX_COMPILER_ID MATCHES MSVC) OR
        ...
        (CONAN_COMPILER STREQUAL "sunstudio" AND NOT CMAKE_CXX_COMPILER_ID MATCHES "SunPro") )
